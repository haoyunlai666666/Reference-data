...
<body>
 ...
 gradient.addColorStop(0.1, 'rgba(118, 75, 162, 0.8)'); gradient.addColorStop(0.6, 'rgba(102, 126, 234, 0.3)'); gradient.addColorStop(1, 'rgba(15, 12, 27, 0)');
...
app.post('/upload-to-github', async (req, res) => {
    ...
    try {
        ...
        if (putRes.status === 200 || putRes.status === 201) {
            ...
            return res.status(putRes.status).send(putRes.data);
        }
    } catch (error) {
